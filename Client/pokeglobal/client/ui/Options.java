...
import pokeglobal.client.ui.base.skin.simple.SimpleColorPicker;
/*
...
public class Options extends Frame {
	...
	public void initGUI() {
		...
		}
		{
			...
			try {
				backgroundColor.setSelectedColor(Color.decode(options.get("backgroundColor")));
		...
		/*{
			...
			learnColorLabel.pack();
			learnColorLabel.setLocation(10, 40);
			
			getContentPane().add(learnColorLabel);
		}*/
		/*{
			learnColor = new SimpleColorPicker();
			try {
		...
		}*/
		{
			...
			fullScreen.setSelected(
					Boolean.parseBoolean(options.get("fullScreen")));
		...
		}
		{
			...
			muteSound.setSelected(
					Boolean.parseBoolean(options.get("muteSound")));
				...
				public void actionPerformed(ActionEvent e) {
					try {
						...
						options.put("learnColor",
								learnColor.getColorHexLabel().
								getText());*/
						
						options.remove("backgroundColor");
						options.put("backgroundColor", backgroundColor.getColorHexLabel().getText());
						...
						options.put("muteSound",
								Boolean.toString(muteSound.isSelected()));
						...
						GlobalGame.messageBox("Changes will not take effect until you restart.",
								getDisplay());

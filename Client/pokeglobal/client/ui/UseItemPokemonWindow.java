...
import pokeglobal.client.logic.Item;
	...
	public UseItemPokemonWindow(final int itemID, boolean moveSelect, OurPokemon [] pokes) {
		...
		for(int i = 0; i < pokes.length; i++) {
			if(pokes[i] != null) {
				...
				label[i].setFont(GlobalGame.getDPFontSmall());
				...
				if(moveSelect) {
					...
					case 0:
						select[i].addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								GlobalGame.getPacketGenerator().write("Bu" + itemID + "," + 0);
								close();
							}
						});
						break;
					case 1:
						select[i].addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								GlobalGame.getPacketGenerator().write("Bu" + itemID + "," + 1);
								close();
							}
						});
						break;
					case 2:
						select[i].addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								GlobalGame.getPacketGenerator().write("Bu" + itemID + "," + 2);
								close();
							}
						});
						break;
					case 3:
						select[i].addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								GlobalGame.getPacketGenerator().write("Bu" + itemID + "," + 3);
								close();
							}
						});
						break;
					case 4:
						select[i].addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								GlobalGame.getPacketGenerator().write("Bu" + itemID + "," + 4);
								close();
							}
						});
						break;
					case 5:
						select[i].addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
								GlobalGame.getPacketGenerator().write("Bu" + itemID + "," + 5);
								close();
							}
						});
						break;

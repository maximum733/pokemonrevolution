...
public class Battle extends Frame {
	...
	public Battle(GameClient game) {
		thisGame = game;
		initComponents();
	}
	
	public Battle(String playerName, PacketGenerator p, OurPokemon[] playerPokes, int playerInd, GameClient game) {
		thisGame = game;
		packetGen = p;
	...
	public void initComponents() {
		...
		messages.setFont(GameClient.getDPFontSmall());
		...
		f1 = new ImageButton();
		f1.setFont(GameClient.getDPFontSmall());
		...
		f2 = new ImageButton();
		f2.setFont(GameClient.getDPFontSmall());
		...
		f3 = new ImageButton();
		f3.setFont(GameClient.getDPFontSmall());
		...
		f4 = new ImageButton();
		f4.setFont(GameClient.getDPFontSmall());
		...
		f5 = new ImageButton();
		f5.setFont(GameClient.getDPFontSmall());
		...
		f6 = new ImageButton();
		f6.setFont(GameClient.getDPFontSmall());
		...
		f7 = new ImageButton();
		f7.setFont(GameClient.getDPFontSmall());
	...
	public void setCenter() {
        int height = GameClient.height;
        int width = GameClient.width;

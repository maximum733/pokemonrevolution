...
import polr.client.ui.base.ListBox;
...
public class SpriteChooser extends Frame {
	...
	public SpriteChooser() {
		...
		m_spriteList = new ListBox(Arrays.asList(new String[] { "girl",
				"girlfive", "girleight", "girleleven", "girlfifteen",
				"girlfour", "girlfourteen", "girlnine", "girlseven", "girlsix",
				"girlsixteen", "girlten", "girlthirteen", "girlthree",
				"girltwelve", "girltwo", "guy", "guyeight", "guyeleven",
				"guyfive", "guyfour", "guyfourteen", "guynine", "guyseven",
				"guysix", "guyten", "guythirteen", "guythree", "guytwelve",
				"guytwo", "hiker", "hikertwo", "karateguy", "karateguytwo",
				"lady", "ladyfive", "ladyfour", "ladyseven", "ladysix",
				"ladythree", "ladytwo", "lass", "man", "manfive", "manfour",
				"manthree", "mantwo", "nerdthree", "sailor", "supernerd",
				"swimmerguy", "youngster", "youngsterthree", "youngstertwo",
				"dude", "fatguy", "fatguytwo", "fisherman", "fishermantwo",
				"camperboy", "campergirl", "campergirltwo", "camperboytwo",
				"bugcatcher", "bugcatchertwo",

...
public class PokeChooser extends javax.swing.JDialog {
	...
	public PokeChooser(java.io.PrintWriter out, GlobalGame g) {
	...
	public void loadImage(JComboBox selector, JLabel surface) {
		...
		if (selector.getSelectedIndex() + 1 != 29
			...
			case 1:
				...
				break;
			case 2:
				path = "res/sprites/front/normal/0" + setSpriteNumber(selector)
						+ "-3.png";
				break;
			case 3:
				path = "res/sprites/front/normal/" + setSpriteNumber(selector)
						+ "-3.png";
				break;
			default:
			...
			ImageIcon pic = null;
			try {
				pic = new ImageIcon(this.getClass().getClassLoader()
						.getResource(path));

				java.awt.Image pic2 = createImage(new java.awt.image.FilteredImageSource(
						pic.getImage().getSource(),
						new java.awt.image.CropImageFilter(0, 0, 80, 80)));

				pic.setImage(pic2.getScaledInstance(40, 40,
						java.awt.Image.SCALE_SMOOTH));
			} catch (NullPointerException e) {
				System.out.println(setSpriteNumber(selector));
			}
			surface.setIcon(pic);
		} else {
			switch (String.valueOf(selector.getSelectedIndex() + 1).length()) {

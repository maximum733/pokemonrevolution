...
public abstract class TextComponent extends Container {
	 ...
	 * 
	 * @return the appearance set for this component 1.5 feature public
	 *         TextComponentAppearance getAppearance() { return
	 *         (TextComponentAppearance)super.getAppearance(); }
	 */
	...
	public void setAppearance(ComponentAppearance appearance) {
		if (!(appearance instanceof TextComponentAppearance))
			throw new IllegalArgumentException(
					"must pass instance of text component appearance");

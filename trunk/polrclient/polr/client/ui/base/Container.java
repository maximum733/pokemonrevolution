...
import polr.client.ui.base.layout.StaticLayout;
...
public class Container extends Component {
	 ...
	 * passing false. This avoids issues that would be caused by updating the
	 * appearance before, say, certain variables are initialized on the
	...
	/**
	 * Called to ensure the z-ordering of this container's children is correct.
	 ...
	 * @return <tt>true</tt> if the child list changed as a result of this call
	 */
	 ...
	 * 
	 * @param c
	 *            the componenet to check against
	 * @return <tt>true</tt> if this container contains the specified component
	 */
	public boolean containsChild(Component c) {
		return children.contains(c); // TODO: use binarySearch(c,zcomp) if not
										// dirty
	}

...
/**
 * The Padding class holds the basic insets for a component. These insets
 * include top, left, right and bottom size.
 * 
 * @author davedes
 */
public class Padding {
	 ...
	 * 
	 * @param num
	 *            the spacing to apply to all edges
	 */
	 ...
	 * 
	 * @param pad
	 *            the Padding object to use for the spacing
	 */
	...
	/**
	 * Returns <tt>true</tt> if the given Object is an instance of Padding with
	 * the same spacing as this Padding, otherwise returns <tt>false</tt>.
	 * 
	 * @param obj
	...
	public boolean equals(Object obj) {
		if (obj instanceof Padding) {
			...
			return top == p.top && left == p.left && bottom == p.bottom
					&& right == p.right;
		} else
			return false;
	}
	 ...
	 * 
	 * @param pad
	 *            the Padding to use for the new spacings
	 */
	...
	public String toString() {
		return super.toString() + "[" + top + ", " + left + ", " + bottom
				+ ", " + right + "]";
	}
}

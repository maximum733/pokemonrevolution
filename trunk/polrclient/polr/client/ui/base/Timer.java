...
/**
 * <p>
 * A simple Sui-based Timer for using delays and "waits" within a GUI
 * environment.
 * </p>
 * 
 * @author davedes
...
public class Timer {
	...
	/**
	 * Fires the specified action event to all action listeners in this timer.
	 * 
	 * 
	 * @param command
	...
	/*
	 * public void setDirection(int direction) { if (direction!=ADVANCE &&
	 * direction!=REVERSE) throw new
	 * IllegalArgumentException("invalid direction argument"); this.direction =
	 * direction; }
	 * 

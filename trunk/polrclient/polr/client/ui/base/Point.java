...
public class Point {
	 ...
	 * 
	 * @param x
	 *            the x position in the coordinate space
	 * @param y
	 *            the y position in the coordinate space
	 */
	...
	/**
	 * Creates a new instance of Point using the (x,y) coordinates from the
	 * specified point.
	 * 
	 * @param p
	 *            a point
	...
	/**
	 * Sets the location of this Point using the location of the specified Point
	 * object.
	 * 
	 * @param p
	 *            a point to use for new x and y positions
	 */
	...
	/**
	 * Returns <tt>true</tt> if the given Object is an instance of Point with
	 * the same location as this point, otherwise returns <tt>false</tt>.
	 * 
	 * @param o

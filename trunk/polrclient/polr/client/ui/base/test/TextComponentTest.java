...
public class TextComponentTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		field.setLocation(passBox.getX(), passBox.getY() + passBox.getHeight()
				+ 10);
		 ...
		 * bar.setLocation(100, 100); bar.setSize(16, 100);
		 * bar.getSlider().setThumbSize(.10f); bar.setBackground(Color.blue);
		 * bar.setOpaque(true);
		 */
		display.add(pane);
	}

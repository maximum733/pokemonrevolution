...
public class SliderTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		slider2.setLocation(slider.getX(), slider.getY() + 45
				+ slider.getHeight());
		...
		// TODO: fix glitch when setting minimum/max size on window (inproper
		// size)
		// TODO: fix glitch where X isn't painted on close button if its
		// disabled

...
import polr.client.ui.base.DraggableContainer;
...
public class ColorPickerTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		window.setSize(picker.getWidth() + 5, picker.getHeight()
				+ window.getTitleBar().getHeight());
	...
	public void render(GameContainer container, Graphics g)
		...
		g.drawString(
				"Change the picker container with SPACE (window / draggable)",
				10, 25);

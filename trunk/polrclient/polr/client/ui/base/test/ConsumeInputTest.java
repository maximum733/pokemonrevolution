...
public class ConsumeInputTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		/*
		 * MouseListener press = new MouseAdapter() { public void
		 * mousePressed(MouseEvent e) {
		 * System.out.println("Press From sui: "+e); } public void
		 * mouseReleased(MouseEvent e) {
		 * System.out.println("Release From Sui: "+e); } public void
		 * mouseDragged(MouseEvent e) { System.out.println("Drag from Sui: "+e);
		 * } };
		 * 
		 * Label label = new Label("Testeroo") { protected boolean
		 * isConsumingEvents() { return true; } }; label.pack();
		 * label.setBackground(Color.blue); label.setOpaque(true);
		 * label.setLocation(250, 300); label.setName("label");
		 * label.addMouseListener(press); disp.add(label);
		 * 
		 * Frame win = new Frame("Test") { protected boolean isConsumingEvents()
		 * { return true; } }; win.setName("test window"); win.setSize(200,
		 * 200); win.setLocation(200, 200);
		 * win.getTitleBar().addMouseListener(press); //disp.add(win);
		 */
	}

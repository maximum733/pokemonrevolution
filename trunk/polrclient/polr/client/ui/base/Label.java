...
/**
 * Label is the base class for displaying a String and/or Image on a component.
 * Text is always drawn over images, which are drawn over the color background
 * (if opaque).
 * <p>
 * Text and images can be aligned horizontally and/or vertically through
 * setHorizontalAlignment and setVerticalAlignment.
 * <p>
...
public class Label extends Container {
	...
	protected Color disabledColor = Sui.getTheme().getDisabledMask()
			.darker(.5f);
	 ...
	 * 
	 * @param image
	 *            the image to be displayed (rendered below text)
	 * @param text
	 *            the text to be displayed
	 */
	 ...
	 *            the alignment constant; either LEFT_ALIGNMENT,
	 ...
	 * 
	 * @param vertAlignment
	 *            the alignment constant; either TOP_ALIGNMENT,
	 ...
	 * variable <tt>yoffset</tt>. Whenever the text changes, this method is used
	 * to store the new offset in the <tt>yoffset</tt> variable.
	 * 

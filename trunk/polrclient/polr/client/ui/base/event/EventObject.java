...
public class EventObject implements java.io.Serializable {
	...
	/**
	 * Creates a new event with the specified params. IDs passed should not be
	 * equal to 0 unless an ID_UNDEFINED is intended.
	 * 
	 * @param source
	...
	/**
	 * Creates a new event with the specified source. All events created using
	 * this constructor will have an ID of 0, ID_UNDEFINED.
	 * 
	 * @param source
	 *            the container which created this event
	 */

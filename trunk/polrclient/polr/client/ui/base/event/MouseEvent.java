...
/**
 * A mouse event, including motion and press/release. Mouse events will hold the
 * absolute and local x and y positions and often the button that is pressed.
 * 
 * @author davedes
 * @since b.0.2
 */
public class MouseEvent extends EventObject {
	 ...
	 *            the event type id
	 * @param button
	 *            the button index or -1 if it's unknown/undefined
	 * @param x
	 ...
	 *            the old y position
	 * @param absx
	 *            the absolute x position to the game container
	 * @param absy
	 *            the absolute y position to the game container
	 */
	public MouseEvent(Object source, int id, int button, int x, int y, int ox,
	...
	/**
	 * Creates a new mouse event with the specified params. The old x and y
	 * values will be equal to the x and y values using this constructor.
	 * 
	 * @param source
	 *            the source
	 * @param id
	 ...
	 *            the absolute y position to the game container
	 */
	public MouseEvent(Object source, int id, int button, int x, int y,
			int absx, int absy) {
	...
	/**
	 * Creates a new mouse event with the specified params. The old x and y
	 * values will be equal to the x and y values using this constructor. Also,
	 * the button index will be -1, equal to NOBUTTON.
	 * 
	 * @param source
	 *            the source
	 * @param id
	 ...
	 *            the absolute y position to the game container
	 */
	public MouseEvent(Object source, int id, int x, int y, int absx, int absy) {
	...
	/**
	 * Gets the button that initiated the event, or NOBUTTON if no mouse button
	 * was used.
	 * 
	 * @return the button index (starting at 0, conforming to the button
	 *         constants BUTTON1, BUTTON2 and BUTTON3) or NOBUTTON (-1) if it's
	 *         unknown
	 */

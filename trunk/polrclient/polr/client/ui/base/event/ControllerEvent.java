...
/**
 * A controller event, such as button pressed or released. The button returned
 * from getButton() is an index, starting at 1. However, if this event was due
 * to an UP, DOWN, RIGHT, or LEFT action, the returned integer will conform to
 * the button constants defined in this class.
 * 
 * @author davedes
 * @since b.0.2
 */
public class ControllerEvent extends EventObject {
	 ...
	 * 
	 * @param source
	 *            the source that created the event
	 * @param id
	 *            the type of event we are dealing with (BUTTON_PRESSED or
	 *            BUTTON_RELEASED)
	 * @param controller
	 *            the controller
	 * @param button

...
/**
 * A keyboard event, such as key press or key release. Each key event has a key
 * code conforming to the Input key constants and a char value for the key.
 * 
 * @author davedes
 * @since b.0.2
 */
public class KeyEvent extends EventObject {
	 ...
	 * @param id
	 *            the event id, either KEY_PRESSED or KEY_RELEASED
	 * @param key
	 *            the key code
	 * @param chr
	 *            the key char

...
/**
 * Sui is a utility class for the GUI library. It should be used for
 * initializing the system and changing global settings.
 * <p>
...
public class Sui {
	...
	/**
	 * Sets the default font to use when creating new components. This font can
	 * be overridden by skins and UIs.
	 * 
	 * @param f
	 *            the new font
	 */
	...
	/**
	 * Updates the current skin/theme, asking each node in the given tree to
	 * update their appearance by calling:<br />
	 * <code>comp.updateAppearance()</code>
	 * <p>
	 * This will install the "skin default" appearance on the tree. If this is
	 * undesired, it is suggested that you use updateComponentTreeTheme, which
	 * will re-install the currently set appearance.
	 * 
	 * @param c
	 *            the component tree to update
	 */
	...
	/**
	 * Updates the current theme, asking each node in the given tree to update
	 * their appearance by calling:<br />
	 ...
	 * 
	 * 
	 * When a new skin is set, the old skin is uninstalled. The passed skin will
	 * be installed to initialize resources. Most skins will "cache" their
	 * resources to make installation fast.
	 * 
	 * @param s
	 *            the new skin to set
	 * @throws SlickException
	 *             if there was a problem uninstalling the old skin or
	 *             reinstalling the new skin
	 */

...
/**
 * Buttons, text fields and windows are rendered using the colors defined in the
 * current Theme.
 * <p>
 ...
 * 
 * @author davedes
 * @see polr.client.ui.base.Sui#setTheme(SuiTheme)
 * @siTheme1
 */
public interface Theme {
	...
	/**
	 * Component base color. Primary colours are generally used for an "up" or
	 * "still" state.
	 */
	public Color getPrimary1();

	/**
	 * Component light color. Primary colours are generally used for an "up" or
	 * "still" state.
	 */
	public Color getPrimary2();

	/**
	 * Component dark color. Primary colours are generally used for an "up" or
	 * "still" state.
	 */
	public Color getPrimary3();

	/**
	 * Component base color (secondary). Secondary colours are generally used
	 * for an "rollover" or "animate" state.
	 */
	public Color getSecondary1();

	/**
	 * Component light color (secondary). Secondary colours are generally used
	 * for an "rollover" or "animate" state.
	 */
	public Color getSecondary2();

	/**
	 * Component dark color (secondary). Secondary colours are generally used
	 * for an "rollover" or "animate" state.
	 */
	...
	/**
	 * Component border light color (secondary). Generally used for special
	 * components such as windows/dialogs.
	 */
	public Color getSecondaryBorder1();

	/**
	 * Component border dark color (secondary). Generally used for special
	 * components such as windows/dialogs.
	 */

...
/**
 * A basic, clickable button component. <tt>SuiButtons</tt> are rendered based
 * on their state: UP, DOWN, or ROLLOVER. Images can be set for each state.
 * <p>
 * A button will be "hit" when the first mouse button is clicked and released
 * over it (MouseEvent.BUTTON1).
 * <p>
 * All SuiButtons are created with a padding of 5, and with text and images
 * initially centered.
 * 
 * 
 * @author davedes
...
public class Button extends Label {
	...
	/**
	 * Creates a button with the specified text, which also acts as the action
	 * command String.
	 * 
	 * @param text
	...
	/**
	 * Sets the action command to be passed to <tt>ActionEvent</tt>s when this
	 * button is clicked.
	 * 
	 * 
	 * @param t
	...
	/**
	 * Overridden to set the state of the button to UP if it's being disabled.
	 * 
	 * 
	 * @param b
	 *            <tt>true</tt> if the button should accept clicks
	 * @see polr.client.ui.base.Label#setEnabled(boolean)
	 */
	 ...
	 * 
	 * @param i
	 *            the image or <tt>null</tt> if it shouldn't be drawn
	 */
	...
	/**
	 * Fires a virtual press. Subclasses may override to react to button press
	 * <i>before</i> actions are sent.
	 */
	public void press() {
	 ...
	 * 
	 * @param command
	 *            the action command for the event
	 * @see polr.client.ui.base.event.ActionEvent
	 */

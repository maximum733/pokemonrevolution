 ...
 * @author Matt
 */
public interface ScrollBarAppearance extends ComponentAppearance,
		ScrollConstants {

	/**
	 * Used by subclasses to create the increment/decrement scroll buttons.
	 * Direction is one of INCREMENT (up/right buttons) or DECREMENT (down/left
	 * buttons). Usually a scroll button has a visual key (such as an arrow) as
	 * to which direction will be scrolled by pressing the button.
	 * 
	 * @param bar
	 *            the scroll bar parent
	 * @param direction
	 *            the direction the button will scroll
	 ...
	 * ScrollBar, an IllegalArgumentException will be thrown when this
	 * appearance is installed on a scroll bar.
	 * 
	 * 
	 * 
	 * @param bar
	 *            the bar to create the slider for
	 * @param orientation
	 *            the orientation (matching that of the passed scroll bar) that

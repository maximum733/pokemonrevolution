 ...
 * @author davedes
 */
public class SimpleFrameAppearance extends SimpleContainerAppearance implements
		FrameAppearance {

	private static GradientFill grad = new GradientFill(0f, 0f, Color.white,
			0f, 0f, Color.white);
	...
	public void render(GUIContext ctx, Graphics g, Component comp, Skin skin,
		...
		if (comp.isBorderRendered()) {
			...
			if (!win.getTitleBar().isVisible()
					|| !win.containsChild(win.getTitleBar())) {
	...
	protected class ResizerAppearance extends SimpleLabelAppearance {
		...
		public void install(Component comp, Skin skin, Theme theme) {
			super.install(comp, skin, theme);
			if (skin instanceof SimpleSkin) {
				comp.addMouseListener(((SimpleSkin) skin)
						.getResizeCursorListener());
			}
		}
		...
		public void uninstall(Component comp, Skin skin, Theme theme) {
			...
			if (skin instanceof SimpleSkin) {
				comp.removeMouseListener(((SimpleSkin) skin)
						.getResizeCursorListener());
			}
		}

		public void render(GUIContext ctx, Graphics g, Component comp,
	...
	protected class TitleBarAppearance extends SimpleLabelAppearance {
		...
		private GradientFill grad = new GradientFill(0f, 0f, Color.white, 0f,
				0f, Color.white);

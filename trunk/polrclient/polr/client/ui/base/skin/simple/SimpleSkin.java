...
public class SimpleSkin implements Skin {
	...
	// we can cache some of our appearances, others need to be created &
	...
	public void install() throws SlickException {
		...
		// fonts
		if (font == null)
			font = tryFont("res/skin/shared/verdana.fnt",
					"res/skin/shared/verdana.png");
	}
	...
	private Font tryFont(String s1, String s2) {
		try {
			return new FontUIResource.AngelCodeFont(s1, s2);
		} catch (Exception e) {
			return null;
		}
	}

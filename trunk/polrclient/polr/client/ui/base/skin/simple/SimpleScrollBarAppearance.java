 ...
 * @author davedes
 */
public class SimpleScrollBarAppearance extends SimpleContainerAppearance
		implements ScrollBarAppearance {

	public void install(Component comp, Skin skin, Theme theme) {
		SkinUtil.installFont(comp, ((SimpleSkin) skin).getFont());
		SkinUtil
				.installColors(comp, theme.getPrimary1(), theme.getForeground());
	}

 ...
 * <p>
 * A window is active when one of its children has the focus. A window that is
 * layerable will change its Z index when focused, bringing the window to the
 * "front". The default layer is the layer at which the window should be at.
 * 
 * @author davedes
 */

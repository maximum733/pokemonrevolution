...
public class SpriteFactory {
	...
	public Image getSprite(Dirs dir, boolean isMoving, boolean isLeftFoot,
			String sprite) {
			...
			while ((f = is.readLine()) != null) {
				try {
					if (f.endsWith(".png")) {
						 ...
						 * System.out.println("R: " + c.getRedByte() + " G: " +
						 * c.getGreenByte() + " B:" + c.getBlueByte() + " A:" +
						 * c.getAlphaByte()); c = trans;
						 * System.out.println("N-R: " + c.getRedByte() + " G: "
						 * + c.getGreenByte() + " B:" + c.getBlueByte() + " A:"
						 * + c.getAlphaByte());
						 * 
						 * sheet = sheet.getSubImage (1, 1, sheet.getWidth() -
						 * 2, sheet.getHeight() - 2);
						 */
						spriteSheets.put(f.replace(".png", ""),
								new SpriteSheet("res/sprites/players/" + f, 41,
										51));

...
public class Player {
	...
	public void setFacing(Dirs facing) {
		try {
			curImg = Player.spriteFactory.getSprite(facing, false, leftorright,
					spriteType);
		} catch (Exception e) {
	...
	public void moveUp() {
		svrY -= 32;
		facing = Dirs.Up;
		curImg = spriteFactory
				.getSprite(Dirs.Up, true, leftorright, spriteType);
	...
	public void moveDown() {
		svrY += 32;
		facing = Dirs.Down;
		curImg = spriteFactory.getSprite(Dirs.Down, true, leftorright,
				spriteType);
		leftorright = !leftorright;
		setAnimating(true);
	}
	...
	public void moveLeft() {
		svrX -= 32;
		facing = Dirs.Left;
		curImg = spriteFactory.getSprite(Dirs.Left, true, leftorright,
				spriteType);
		leftorright = !leftorright;
		setAnimating(true);
	}
	...
	public void moveRight() {
		svrX += 32;
		facing = Dirs.Right;
		curImg = spriteFactory.getSprite(Dirs.Right, true, leftorright,
				spriteType);
		leftorright = !leftorright;
		setAnimating(true);
	}

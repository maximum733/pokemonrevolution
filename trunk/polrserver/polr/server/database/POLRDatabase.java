...
import polr.server.battle.Pokemon.ExpTypes;
...
public class POLRDatabase {
	...
	public static void main(String[] args) {
		...
		Ini ini = null;
		try {
			ini = new Ini(new FileInputStream("polr/server/res/db.ini"));
		...
		File userfile = new File("polr/server/res/polrdb.xml");
		userfile.delete();
		try {

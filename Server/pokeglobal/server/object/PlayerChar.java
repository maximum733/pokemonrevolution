...
import pokeglobal.server.battle.NPCBattleField;
...
import pokeglobal.server.database.POLREvolution.EvoTypes;
import pokeglobal.server.map.ServerMap.Directions;
import pokeglobal.server.trade.TradeItem;
...
public class PlayerChar extends Char {
	...
	public boolean isBlocked() {
		return (isBattling()) || (isTalking()) || (isFrozen()) || (isBoxing());
	}
	...
	public boolean isBoxing() {
		return (m_talkingTo != null && m_talkingTo instanceof BoxKeeper);
	}
